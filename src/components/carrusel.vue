...
<script>
import cafe1 from "@/assets/Carrusel/cafe1.jpg";
import cafe2 from "@/assets/Carrusel/cafe2.jpg";
import cafe3 from "@/assets/Carrusel/cafe3.jpg";
import cafe4 from "@/assets/Carrusel/cafe4.jpg";
import cafe5 from "@/assets/Carrusel/cafe5.jpg";
export default {
    data() {
        return {
